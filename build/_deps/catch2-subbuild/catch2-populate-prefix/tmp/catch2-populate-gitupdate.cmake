...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    ...
    WORKING_DIRECTORY "https://github.com/catchorg/Catch2.git"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "FIND_PACKAGE_ARGS/v3.4.0")
...
if(fetch_required)
  message(VERBOSE "Fetching latest from the remote FIND_PACKAGE_ARGS")
  execute_process(
    COMMAND "/usr/bin/git" fetch --tags --force "FIND_PACKAGE_ARGS"
    WORKING_DIRECTORY "https://github.com/catchorg/Catch2.git"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()

set(git_update_strategy "/home/ga4o/SDP/sdp/sdp-2023-24/homework/hw1/template/build/_deps/catch2-src")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'https://github.com/catchorg/Catch2.git'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'https://github.com/catchorg/Catch2.git'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
